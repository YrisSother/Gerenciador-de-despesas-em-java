...
public class DespesaJava {
    ...
    public void categorias2(int num) {
        switch (num) {
            case 1:
                adicionarDespesa(num, despesasFixas, "Despesas Fixas");
                break;
            case 2:
                adicionarDespesa(num, despesasVariaveis, "Despesas Variáveis");
                break;
            case 3:
                adicionarDespesa(num, despesasOpcionais, "Despesas Opcionais");
                break;
            case 4:
                adicionarDespesa(num, despesasEmergenciais, "Despesas Emergenciais");
                break;
            case 5:
                adicionarDespesa(num, despesasInvestimentos, "Despesas de Investimentos");
                break;
            case 6:
    ...
    public void adicionarDespesa(int num, List<Des> lista, String categoria ) {
    ...
    public void adicionarDespesa(String titulo, double valor) {
        this.titulo = titulo;
        this.valor = valor;
    }
}
